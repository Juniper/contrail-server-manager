...
if [ -d %{_builddir}/../tools/puppet-third-party ]; then echo "SM New Modules";  cp -rp %{_builddir}/../tools/puppet-third-party/* %{_builddir}/../build/puppet/contrail/environment/modules/ ; fi
