...
class VncServerManager():
    ...
    _container_roles = [CONTROLLER_CONTAINER, ANALYTICS_CONTAINER, ANALYTICSDB_CONTAINER,
                        AGENT_CONTAINER, LB_CONTAINER, BARE_METAL_COMPUTE]
...
#            match_value = match_values[0]
    ...
    def build_calculated_cluster_params(
        ...
        for role, servers in role_servers.iteritems():
            if (container_roles and
                role in ['config', 'control', 'collector', 'webui', 'database']):
                continue
