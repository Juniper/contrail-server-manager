...
def verify_interface(self, output):
  ...
  self.assertEqual(list[9].strip(), '172.16.70.254')
  self.assertEqual(list[10].strip(), '--dhcp')
...
def verify_bond_interface(self, output):
  ...
  self.assertEqual(list[5].strip(), 'c4:54:44:44:d7:4a')
  self.assertEqual(list[6].strip(), '--bond-opts')
  self.assertEqual(list[7].strip(), '"{"miimon":')
  self.assertEqual(list[8].strip(), '"100",')
  self.assertEqual(list[9].strip(), '"mode":')
  self.assertEqual(list[10].strip(), '"802.3ad",')
  self.assertEqual(list[11].strip(), '"xmit_hash_policy":')
  self.assertEqual(list[12].strip(), '"layer3+4"}"')
  self.assertEqual(list[13].strip(), '--ip')
  self.assertEqual(list[14].strip(), '192.168.100.1/24')
...
def verify_server_cfg(self,output):
 ...
 verify_static_route(self, list[3].strip())
