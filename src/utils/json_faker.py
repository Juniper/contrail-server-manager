...
def pre_validation(options, fschema_json):
    ...
    s = open(options.validateIt,'r').read()
...
def main():
    ...
    OptionParser.add_option('-v', '--validate',action="store", dest="validateIt",help="JSON file to be validated", default=[])
