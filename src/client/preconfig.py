...
class Utils(object):
    ...
    def parse_args(args):
        ...
        parser.add_argument('--no-change-ntp-config', 
                            action='store_true',
                            default=False,
...
class Server(object):
    def __init__(self, server_dict, server_manager_ip,
                 ...
                 no_change_ntp_config = True, ntp_server = ""):
        self.key_path = None
        ...
        self.os_version = ()
        if no_change_ntp_config:
            self.change_ntp_config = False
        else:
            self.change_ntp_config = True
