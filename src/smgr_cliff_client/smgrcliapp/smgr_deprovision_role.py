...
class DeprovisionRole(Command):
    ...
    def get_parser(self, prog_name):
        parser = super(DeprovisionRole, self).get_parser(prog_name)
    ...
    def take_action(self, parsed_args):
        ...
        # end if
        if payload:
            resp = smgrutils.send_REST_request(self.smgr_ip, self.smgr_port, obj="deprovision_role",
