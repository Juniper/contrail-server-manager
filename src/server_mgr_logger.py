...
class ServerMgrTransactionlogger:
    ...
    GET_SMGR_CFG_USER = "GET_SMGR_USER"
    GET_SMGR_CFG_ROLE = "GET_SMGR_ROLE"
    ...
    PUT_SMGR_CFG_USER = "PUT_SMGR_USER"
    PUT_SMGR_CFG_ROLE = "PUT_SMGR_ROLE"
    ...
    DELETE_SMGR_CFG_USER = "DELETE_SMGR_USER"
    DELETE_SMGR_CFG_ROLE = "DELETE_SMGR_ROLE"
