...
#Install puppet 2.7 against 3.x which is got from xenial repo.
...
deb http://packages.medibuntu.org/ xenial free non-free
deb-src http://packages.medibuntu.org/ xenial free non-free
